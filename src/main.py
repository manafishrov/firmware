...
thruster_ctrl = ThrusterController(imu_sensor, pressure_sensor)
    ...
    async def send_heartbeat():
        while True:
            try:
                ...
                logging.info(f"Sent heartbeat - Update rate: {1/thruster_ctrl.time_delay:.2f} seconds - Depth: {pressure_sensor.depth():.2f} m - Temperature: {pressure_sensor.temperature(ms5837.UNITS_Centigrade):.2f} C")
