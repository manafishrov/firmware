...
AHRS_MAHONY_KP= 1.5
AHRS_MAHONY_KI = 0.05
AHRS_ACCEL_MIN_NORM = 1e-3
DEPTH_INTEGRAL_WINDUP_CLIP = 3.0
INTEGRAL_RELAX_THRESHOLD = 0.2
MAX_GYRO_DEG_PER_SEC = 1080.0

# IMU
IMU_READ_FREQUENCY = 120

# Pressure sensor
PRESSURE_SENSOR_READ_FREQUENCY = 100
